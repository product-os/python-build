...
pipeline {
    ...
    parameters {
        ...
        string defaultValue: '', description: 'Set Debian release to use: buster (libffi3.2) or bullseye (libffi3.3) or bookworm (libffi3.4). Default to bookworm', name: 'DEBIAN_BUILD_TAG', trim: true
        string defaultValue: '', description: 'Set Alpine release to use: 3.11 (libffi3.2) or 3.13 (libffi3.3) or 3.15 (libffi3.4). Default to 3.15', name: 'ALPINE_BUILD_TAG', trim: true
