...
pipeline {
    ...
    parameters {
        ...
        string defaultValue: '', description: 'Set Debian release to use, default to buster', name: 'DEBIAN_BUILD_TAG', trim: true
        string defaultValue: '', description: 'Set Alpine release to use, default to 3.11', name: 'ALPINE_BUILD_TAG', trim: true
